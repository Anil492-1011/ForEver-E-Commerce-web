...
const LatestProduct = () => {
  ...
  return (
    <div className='my-12 px-4 md:px-8 lg:px-16'>
        ...
        <p className='text-center w-3/4 m-auto text-xs sm:text-sm md:textbase text-gray-600 my-8'>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the.</p>     
